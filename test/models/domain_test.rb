...
class DomainTest < ActiveSupport::TestCase
  ...
  test "new" do
    ...
    inactive_domain = Domain.new(text: "Test2", description: "test domain", subdomain: "test2", active: false)
    ...
    duplicate_text = Domain.new(text: "Test", description: "domain for testing", subdomain: "tests")
    assert_not duplicate_text.save, "New Domain: Duplicate text saved"

    # Duplicate subdomain Domain
    duplicate_subdomain = Domain.new(text: "My Domain", description: "My own domain", subdomain: "test")
